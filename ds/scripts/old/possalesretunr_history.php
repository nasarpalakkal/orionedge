...
$columns = array(
	...
	array( 'db' => 'cash_pay',      'dt' => 10 ),  
	array( 'db' => 'card_pay',      'dt' => 11 ),    
	array( 'db' => 'descr_en',    'dt' => 12 ),
	array( 'db' => 'displayname',    'dt' => 13 ),
	array( 
            'db' => 'invoice_no', 
            'dt' => 14,
            'formatter' => function( $d, $row ) {				
                return '<a href="exportToExcel/pos_sales_details_export.php?id='.$row[1].'&&ret=2" class="btn btn-success"><i class="fa fa-file-excel-o" style="height: 15px"></i></a>';
            }
       ),	
	array( 
            'db' => 'invoice_no', 
...
$wherecondition = "date between '$formStartDate' and '$formEndDate' and SalesType=1";
