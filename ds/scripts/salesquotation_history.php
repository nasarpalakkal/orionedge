   ...
   array( 
	...
	array( 
            ...
            'formatter' => function( $d, $row ) {
				...
				{
				return '<span class="label label-success">Converted To Sales Order</span>';			
				}
				
            }
       ),
       array( 'db' => 'SalesOrderNumber',    'dt' => 15 ),    
...
if($useridsearch=="")
			{
$wherecondition = "cdate between '$formStartDate' and '$formEndDate' and SalesOrderNumber is NULL";
			}
			else
			{
