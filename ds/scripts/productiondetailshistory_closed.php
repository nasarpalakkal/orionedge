...
array( 
    ...
    'dt' => 7,
    'formatter' => function( $d, $row ) {	
        return '<a href="ProductionDetails.php?id='.$row[1].'"><font color="black">'.$row['FinishedProducts'].'</font></a>';
    }
),	
array( 
    'db' => 'status', 
...
array( 'db' => 'item_descr',    'dt' => 13 ),	 
array( 'db' => 'item_descr_ar',    'dt' => 14 ),
array( 'db' => 'FrommainWarehouse',    'dt' => 15 ),	 
array( 'db' => 'ToMainWarehouse',    'dt' => 16 ),	   	   
